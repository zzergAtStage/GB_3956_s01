...
//  Ввод чисел останавливается при помощи ввода слова "stop"
        ...
        while (proceed)
        {
            inputS = Library.GetNumberS("Input a number");//по хорошему, в либе нужно добавить проверку на ввод числа.
            if (inputS.ToUpper() != "STOP") {
                int number = int.Parse(inputS);// но с учетом работы со сторокой, лучше тут добавить exception
